...
const Bylaws = () => {
  return (
    <div
      className="bg-[url('src/assets/images/bylaws_bg.svg')] bg-contain bg-right-top bg-repeat
                    p-3
                    font-kollektif text-xl"
    >
...
const H1 = ({ children }: Props) => {
  return <h1 className="py-5 font-bebas text-5xl font-medium">{children}</h1>;
};

const H2 = ({ children }: Props) => {
  return <h2 className="py-5 font-bebas text-4xl font-medium">{children}</h2>;
};
